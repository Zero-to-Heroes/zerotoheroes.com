...
public class JobStatusNotification {
	...
	public static class JobOutput {
		...
		@Override
		public String toString() {
			return "JobOutput [id=" + id + ", presetId=" + presetId + ", key=" + key + ", status=" + status
					+ ", statusDetail=" + statusDetail + ", errorCode=" + errorCode + "]";
		}
	}
	...
	public static enum JobState {
		...
		public boolean isTerminalState() {
			return equals(JobState.COMPLETED) || equals(JobState.ERROR);
		}
	}
	...
	@Override
	public String toString() {
		return "JobStatusNotification [state=" + state + ", errorCode=" + errorCode + ", version=" + version
				+ ", jobId=" + jobId + ", pipelineId=" + pipelineId + ", input=" + input + ", outputKeyPrefix="
				+ outputKeyPrefix + ", outputs=" + outputs + "]";
	}
