				...
				hearthstone: {
					...
					plugins: {
						plugins: [
							...
							{name: 'joustjs', player: true, format: ['text/xml'], mediaType: 'game-replay', version: 62, dev: dev},
							{name: 'hsarenadraft', player: true, mediaType: 'arena-draft', version: 15, dev: dev}
						],
