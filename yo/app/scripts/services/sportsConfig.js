		...
		service =
			{
				...
				hearthstone: {
					...
					plugins: {
						plugins: [
							{name: 'parseCardsText', version: 18, dev: dev}, 
							{name: 'parseDecks', version: 32, dev: dev}, 
							{name: 'joustjs', player: true, format: ['text/xml'], mediaType: 'game-replay', version: 84, dev: dev},
