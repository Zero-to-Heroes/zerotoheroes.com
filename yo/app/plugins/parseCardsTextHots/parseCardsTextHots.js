var parseCardsTextHots = {
	talentRegex: /\[\[.+?\]\]/gm,

	execute: function(review, text) {
		var matches = text.match(parseCardsTextHots.talentRegex);
		var result = text;
	   // console.log('in hots plugin for ', review, text);
		...
		if (matches) {
			matches.forEach(function(match) {
				...
				var talent = parseCardsTextHots.getTalent(talentName);
				//console.log('talent', talent);
				if (talent) {
					var template = parseCardsTextHots.template(talent);
					var html = parseCardsTextHots.html(talent);
