...
public class Notifications {
	...
	//
	// DateTime earliestDate = new
	// DateTime().minusDays(MAX_DURATION_FOR_NOTIFICATIONS);
	//
	// for (Iterator<Notification> iterator = notifications.iterator();
	// iterator.hasNext();) {
	// Notification notif = iterator.next();
	// if (new DateTime(notif.getCreationDate()).isBefore(earliestDate) &&
	// notif.getReadDate() != null) {
	// iterator.remove();
	// }
	// }
	// }
