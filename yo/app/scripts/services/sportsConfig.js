		...
		service =
			{
				...
				hearthstone: {
					...
					plugins: {
						plugins: [
							{name: 'parseCardsText', version: 34, dev: dev},
							{name: 'parseDecks', version: 44, dev: dev},
							{name: 'manastorm', player: true, format: ['text/xml'], mediaType: 'game-replay', version: 172, options: { useCompressedImages: true }, dev: dev},
