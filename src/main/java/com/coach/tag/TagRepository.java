...
public class TagRepository {
	...
	private static Map<Sport, List<Tag>> buildTagsList() {
		...
		// Ranks
		hearthstone.add(new Tag("Rank 25", "skill-level"));
		hearthstone.add(new Tag("Rank 24", "skill-level"));
		hearthstone.add(new Tag("Rank 23", "skill-level"));
		hearthstone.add(new Tag("Rank 22", "skill-level"));
		hearthstone.add(new Tag("Rank 21", "skill-level"));
		hearthstone.add(new Tag("Rank 20", "skill-level"));
		hearthstone.add(new Tag("Rank 19", "skill-level"));
		hearthstone.add(new Tag("Rank 18", "skill-level"));
		hearthstone.add(new Tag("Rank 17", "skill-level"));
		hearthstone.add(new Tag("Rank 16", "skill-level"));
		hearthstone.add(new Tag("Rank 15", "skill-level"));
		hearthstone.add(new Tag("Rank 14", "skill-level"));
		hearthstone.add(new Tag("Rank 13", "skill-level"));
		hearthstone.add(new Tag("Rank 12", "skill-level"));
		hearthstone.add(new Tag("Rank 11", "skill-level"));
		hearthstone.add(new Tag("Rank 10", "skill-level"));
		hearthstone.add(new Tag("Rank 9", "skill-level"));
		hearthstone.add(new Tag("Rank 8", "skill-level"));
		hearthstone.add(new Tag("Rank 7", "skill-level"));
		hearthstone.add(new Tag("Rank 6", "skill-level"));
		hearthstone.add(new Tag("Rank 5", "skill-level"));
		hearthstone.add(new Tag("Rank 4", "skill-level"));
		hearthstone.add(new Tag("Rank 3", "skill-level"));
		hearthstone.add(new Tag("Rank 2", "skill-level"));
		hearthstone.add(new Tag("Rank 1", "skill-level"));
		hearthstone.add(new Tag("Legend", "skill-level"));
		hearthstone.add(new Tag("Arena 0 wins", "skill-level"));
		hearthstone.add(new Tag("Arena 1 win", "skill-level"));
		hearthstone.add(new Tag("Arena 2 wins", "skill-level"));
		hearthstone.add(new Tag("Arena 3 wins", "skill-level"));
		hearthstone.add(new Tag("Arena 4 wins", "skill-level"));
		hearthstone.add(new Tag("Arena 5 wins", "skill-level"));
		hearthstone.add(new Tag("Arena 6 wins", "skill-level"));
		hearthstone.add(new Tag("Arena 7 wins", "skill-level"));
		hearthstone.add(new Tag("Arena 8 wins", "skill-level"));
