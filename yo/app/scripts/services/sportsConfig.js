		...
		service =
			{
				...
				hearthstone: {
					...
					plugins: {
						plugins: [
							{name: 'parseCardsText', version: 28, dev: dev}, 
							{name: 'parseDecks', version: 42, dev: dev}, 
							{name: 'manastorm', player: true, format: ['text/xml'], mediaType: 'game-replay', version: 123, dev: dev},
							{name: 'windrunner', player: true, mediaType: 'arena-draft', version: 27, dev: dev}
						],
