		...
		service =
			{
				...
				hearthstone: {
					...
					plugins: {
						plugins: [
							{name: 'parseCardsText', version: 15, dev: dev}, 
							{name: 'parseDecks', version: 30, dev: dev}, 
							{name: 'joustjs', player: true, format: ['text/xml'], mediaType: 'game-replay', version: 72, dev: dev},
