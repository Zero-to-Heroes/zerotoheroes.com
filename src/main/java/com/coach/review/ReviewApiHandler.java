...
//		activatePlugins(currentUser, review, null);
...
//	}
	...
	public @ResponseBody ResponseEntity<Review> publish(@PathVariable("reviewId") final String id,
		...
		if (!StringUtils.isEmpty(currentUser) && !UserAuthority.isAnonymous(authorities)) {
			addAuthorInformation(Sport.HearthStone, review, currentUser);
		}
		else {
...
//	}
	...
	private void addAuthorInformation(Sport sport, Review entity, String currentUser) {
