				...
				hearthstone: {
					...
					plugins: {
						plugins: [
							...
							{name: 'parseDecks', version: 15, dev: dev}, 
							{name: 'joustjs', player: true, format: ['text/xml'], mediaType: 'game-replay', version: 57, dev: dev},
							{name: 'hsarenadraft', player: true, mediaType: 'arena-draft', version: 13, dev: dev}
						],
